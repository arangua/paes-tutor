...
export const TIME_CONSTANTS = {
  ...
  // 5 minutos
  EXAMS_CACHE_TTL_MS: 10 * 60 * 1000,
  // 10 minutos
  ATTEMPTS_CACHE_TTL_MS: 1 * 60 * 1000,
  // 1 minuto
  CACHE_CLEANUP_INTERVAL_MS: 10 * 60 * 1000,
  // 10 minutos

  // Rate limiting
  GENERAL_RATE_LIMIT_WINDOW_MS: 10 * 1000,
  // 10 segundos
  AUTH_RATE_LIMIT_WINDOW_MS: 60 * 1000,
  // 1 minuto
  READ_RATE_LIMIT_WINDOW_MS: 10 * 1000,
  // 10 segundos
  WRITE_RATE_LIMIT_WINDOW_MS: 60 * 1000,
  // 1 minuto
  SENSITIVE_RATE_LIMIT_WINDOW_MS: 5 * 60 * 1000,
  // 5 minutos
  CHALLENGE_RATE_LIMIT_WINDOW_MS: 60 * 60 * 1000,
  // 1 hora

  // Intentos
  NEW_ATTEMPT_THRESHOLD_MS: 1000,
  // 1 segundo

  // Auto-guardado
  AUTO_SAVE_DELAY_MS: 2000,
  // 2 segundos de inactividad antes de guardar

  // UI
  SUCCESS_MESSAGE_DISPLAY_MS: 3000,
  // 3 segundos para mostrar mensaje de éxito
  TOOLTIP_POSITION_UPDATE_DELAY_MS: 50,
  // 50ms para actualizar posición de tooltip
  FOCUS_DELAY_MS: 100,
  // 100ms para enfocar input después de abrir
  ANIMATION_DELAY_MS: 300,
  // 300ms para animaciones
...
export const LIMIT_CONSTANTS = {
  MAX_OFFSET: 10000,
  // Máximo offset permitido para prevenir queries costosas
  MAX_STRING_LENGTH: 10000,
  // Longitud máxima para prevenir DoS
  MAX_RATE_LIMIT_ENTRIES: 10000,
  // Limitar tamaño del store de rate limiting
  MAX_MATERIALS_CONTEXT: 10,
  // Máximo de materiales de estudio para contexto de IA
  MAX_SEARCH_RESULTS: 200,
  // Máximo de resultados a buscar antes de ordenar por relevancia
  MAX_ANALYTICS_ATTEMPTS: 10000,
  // Máximo de intentos para análisis de comparación
...
export const VALIDATION_CONSTANTS = {
  MIN_RECOMMENDED_ENCRYPTION_KEY_LENGTH: 32,
  // Longitud mínima recomendada para AES-256
