...
function Label({
  ...
  if (stryMutAct_9fa48("20724")) {
    ...
    stryCov_9fa48("20724");
    return <LabelPrimitive.Root data-slot="label" className={cn(stryMutAct_9fa48("20725") ? "" : (stryCov_9fa48("20725"), 'flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50'), className)} {...props} />;
  }
}
export { Label };